...
n = int(input('Quantos termos você quer mostrar? ')) #lê o número de termos desejado
t1 = 0 #define o primeiro termo como 1 (regra)
t2 = 1 #define o segundo termo como 0 (regra)
print('{} -> {}'.format(t1, t2), end='') #mostra os dois primeiros termos
...
while cont <= n: #enquanto o contador for menor ou igual o número do input fazer:
    ...
    print(' -> {}'.format(t3), end='') #mostra o t3
