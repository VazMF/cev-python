...
nome = str(input('Nome completo: ')).strip() #input do nome completo na variavel nome
print('\033[31mANALISANDO NOME...\033[m') #print para a simulacao de analise
sleep(1) #sleep
print(f'Resultado: {"silva" in nome.lower()}') #joga o nome pra minúsculas e procura a palavra silva
