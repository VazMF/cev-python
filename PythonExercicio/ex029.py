...
velocidade = int(input('Em Km/h, qual a velocidade do seu carro? ')) #input da velocidade do carro na variavel velocidade
...
if velocidade > 80: #define que se a velocidade informada for maior que 80 será exbido o print abaixo
    print(f'Você está a \033[31m{velocidade}km/h\033[m, o limite nessa pista é de 80km/h, você \033[4;31mserá multado\033[m no valor de \033[31mR${multa:.2f}!\033[m')
