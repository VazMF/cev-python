...
print('\033[31m---COMPARANDO VALORES---\033[m') #titúlo
n1 = int(input('Primeiro número inteiro: ')) #input do primeiro valor
n2 = int(input('Segundo número inteiro: ')) #input do segundo valor
if n1 > n2: #se n1 for maior que n2 execute o comando abaixo e termine
    ...
    print('Os dois valores são \033[33mIGUAIS\033[m') #se os números forem iguais
print('\033[31m-\033[m' * 24) #fim
